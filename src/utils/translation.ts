...
const Texts = {
    ...
    "clear-data-confirm": "Do you want to clear all Bolt Xcloud settings and data?",
    ...
    "increase": "Increase",
    "install-android": "Bolt Xcloud app for Android",
    "invites": "Invites",
    "japan": "Japan",
    "jitter": "Jitter",
    ...
    "limit-fps": "Limit FPS",
    "load-failed-message": "Failed to run Bolt Xcloud",
    ...
    "profile-applied": "Profile applied: {0}",
    "smart-actions": "Smart actions",
    "smart-actions-note": "One tap applies a tuned profile and updates key settings.",
    "smart-profile-auto": "Auto adapt",
    "smart-profile-tv": "Boost for TV",
    "smart-profile-android": "Balance for Android",
    "smart-profile-pc": "Quality for PC",
    "smart-toggle-stats": "Toggle stream stats",
    "settings-search-placeholder": "Search settings",
    "runtime-error-title": "Bolt Xcloud error",
    "runtime-error-copy": "Copy error",
    "runtime-error-copied": "Copied",
    "network-profile": "Network profile",
    "network-profile-note": "Controls resolution and bitrate targets.",
    "video-profile": "Video profile",
    "video-profile-note": "Adjusts processing and sharpness bias.",
    "controller-response": "Controller response",
    "controller-response-note": "Higher response uses more CPU.",
    "compact-ui": "Compact UI",
    "compact-ui-note": "Tighter spacing for small screens.",
    "profile-low": "Low",
    ...
    "support-better-xcloud": "Support Bolt Xcloud",
