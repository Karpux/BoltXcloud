...
var SCRIPT_VERSION = "6.4.8-beta", SCRIPT_VARIANT = "full", AppInterface = window.AppInterface;
UserAgent.init();
...
true` + text;
 ...
 ignoreByogSection(str) {
  ...
  if (index > -1 && (index = PatcherUtils.lastIndexOf(str, "return", index, 100)), index < 0) return !1;
  return str = PatcherUtils.insertAt(str, index, "return null;"), str;
 },
